...
public class ArrayList<T> extends AbstractList<T> implements List<T> {
  ...
  /**
   * Desplaza todos los elementos desde el índice especificado hacia la derecha una posición.
   * Abre un espacio en la posición indicada para insertar un nuevo elemento.
   *
   * @param index la posición donde se insertará el nuevo elemento
   * @throws IndexOutOfBoundsException si el índice no está en el rango [0, size]
   */
  ...
  /**
   * Desplaza todos los elementos desde el índice especificado + 1 hacia la izquierda una posición.
   * Elimina efectivamente el elemento en la posición indicada.
   *
   * @param index la posición del elemento que se eliminará
   * @throws IndexOutOfBoundsException si el índice no está en el rango [0, size - 1]
   */
